                                                        ...
                                                        <table class="table" id="table">
                                                            ...
                                                            @foreach ($startup as $ment)
                                                                <tr class="mentor{{$ment->id}}">
                                                                    ...
                                                                    <td>
                                                                        <a href="/list/startup/connection/{{$ment->id}}" class="btn btn-primary btn-sm" >
                                                                            <i class="glyphicon glyphicon-info-sign"></i>
                                                                        </a>
                                                                        <a href="/admin/view/user/profile/{{$ment->id}}" class="btn btn-info btn-sm" >
                                                                        <i class="glyphicon glyphicon-eye-open"></i>
                                                                        </a>
                                                                    {{--
                                                                        <a onclick="viewdetil( {{ json_encode($ment) }} )" href="{{ URL::to('/admin/view/startup/'.$ment->id) }}" class="btn btn-info btn-sm" >
                                                                        <i class="glyphicon glyphicon-eye-open"></i>
                                                                        </a>
                                                                        <a onclick="Editdetail( {{ json_encode($ment) }}  )" href="{{ URL::to('/edit/statup/'.$ment->id) }}" class="btn btn-warning btn-sm" >
