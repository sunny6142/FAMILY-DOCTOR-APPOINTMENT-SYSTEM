                                            ...
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    ...
                                                    <div class="d-inline">
                                                        ...
                                                        {{--<span><a href="/mentor/startup/approval/1"> Pending </a><code><a href="/mentor/startup/approval/2"> Approved </a></code><a href="/mentor/startup/approval/3"> & Deny</a></span>--}}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                ...
                                                <div class="card-block table-border-style">
                                                    <div class="table-responsive">
                                                        <table class="table" id="table">
                                                            <thead>
                                                                <tr>
                                                                   ...
                                                                   <!-- <th class="text-center" width="150px">
                                                                        <a href="#" id="add_mentor_model" class="btn btn-success btn-sm">
                                                            ...
                                                            ?>
                                                            @foreach ($list as $l)
                                                                <tr class="mentor{{$l->id}}">
                                                                    <td class="text-left">{{ $no++}} </td>
                                                                    <td class="text-left">{{ $l->name }} </td>
                                                                    <td class="text-left">{{ $l->mentoring_session_time_v  }} </td>
                                                                    <td class="text-danger text-left">{{ $l->created_at }} </td>
                                                                    <td class="text-left">
                                                                        @if($mentor_status == 1)
                                                                        <a onclick="viewdetil( {{ json_encode($l) }} )" href="#" class="btn btn-info" >
                                                                         <i class="glyphicon glyphicon-eye-open"></i> Approval Required     
                                                                        </a>
                                                                        @endif
                                                                        <!--
                                                                        <a onclick="Editdetail( {{ json_encode($l) }}  )" href="#" class="btn btn-warning btn-sm" >
                                                                            <i class="glyphicon glyphicon-pencil"></i>
                                                                        </a>
                                                                        <a onclick="Delete_user( {{ json_encode($l) }} )" href="#" class="btn btn-danger btn-sm">
    ...
    <div class="modal-dialog modal-md " role="document" style="width: auto;">
        <div class="modal-content">
            ...
            <div class="card" style=";">
                <div class="view-approval" style="width:150px; height:150px; display: block;margin-left: auto; margin-right: auto;">
