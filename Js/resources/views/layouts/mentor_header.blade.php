            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{ asset('') }}public/images/{{ Auth::user()->image  }}" class="profile-pic" /> 
                            {{ Auth::user()->name }}
                            </a>
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="{{route('mentor.profile')}}"><i class="ti-user"></i> Profile</a></li>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> 
                            <a href="{{route('mentor.profile')}}" aria-expanded="false">
                                <i class="fa fa-tachometer"></i>
                                <span class="hide-menu">Profile</span>
                            </a>
                        </li>
                        <li> 
                            <a href="{{route('mentor.startup.list')}}" aria-expanded="false">
                                <i class="fa fa-tachometer"></i>
                                <span class="hide-menu">Start Up Mentored</span>
                            </a>
                        </li>
                        ...
                        <li> 
                            <a href="{{ url('/mentor/startup/approval/1') }}" aria-expanded="false">
