                                                        ...
                                                        <table class="table" id="table">
                                                            ...
                                                            @foreach ($list as $ment)
                                                                <tr class="mentor{{$ment->id}}">
                                                                    ...
                                                                    <td>
                                                                        <a href="/admin/view/accept/mentor/{{$ment->request_mentor}}" class="btn btn-warning btn-sm" >
                                                                            Detail 
                                                                        </a>
                                                                    </td>
                                                                    <td> 
                                                                        <a href="/admin/view/user/profile/{{$ment->user_id}}" class="btn btn-info btn-sm" >
                                                                            Startup 
                                                                        </a>
                                                                    
                                                                        <a href="/admin/view/mentor/profile/{{$ment->admins}}" class="btn btn-info btn-sm" >
                                                                            Mentor 
                                                                        </a>
                                                                    </td>
                                                                    <td class="text-danger">
                                                                        @if($ment->user_feedback_status == null)
                                                                            Not Available
                                                                        @else
                                                                            <a  href="/admin/view/startup/feedback/{{$ment->request_mentor}}" class="btn btn-success btn-sm" >
                                                                                Feedback
                                                                            </a>
                                                                        @endif
                                                                    </td>
                                                                    ...
                                                                    <td class="text-danger text-left">
                                                                        @if($ment->mentor_feedback_status == null)
                                                                            Not Available
                                                                        @else
                                                                            <a href="/admin/view/mentor/feedback/{{$ment->request_mentor }}" class="btn btn-success btn-sm" >
                                                                                Feedback
                                                                            </a>
                                                                        @endif
                                                                    </td>
