                                                        ...
                                                        <table class="table" id="table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-info text-left" width="150px">
                                                            ...
                                                            @foreach ($request_mentor as $ment)
                                                                <tr class="mentor{{$ment->id}}">
                                                                    ...
                                                                    @if($ment->mentor_status == 1) 
                                                                        <span class="text-danger"> Pending by Mentor</span>
                                                                    @elseif($ment->user_status == 1)
                                                                        <span class="text-info"> Pending by Startup</span>
                                                                    @elseif($ment->user_status == 2)
