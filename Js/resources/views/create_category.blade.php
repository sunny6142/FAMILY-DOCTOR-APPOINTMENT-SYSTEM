                                                                                    ...
                                                                                    <div class="tab pt-3">
                                                                                        ...
                                                                                        <section>
                                                                                            <div class="form-group row add">
                                                                                                ...
                                                                                                <div class="col-sm-8">
                                                                                                    <input type="text" style="width:300px" class="form-control" id="cat" name="cat" placeholder="Enter here">
            ...
            $.ajax({
               ...
               success: function(data) {
                   ...
                   else
                   {
                       ...
                       $("#msg").text("Category Successfully Added");
                       //updatelist();
                   }
                    $('.mentor_modal_button').addClass('hidden');
