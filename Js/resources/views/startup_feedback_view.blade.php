                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div role="form" id="form2" class="w-95" style = "margin: 0 auto;">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-12">
                                                                                        <textarea row="4" style="background:white" type="text" class="form-control" id="qualitative_feedback" name="qualitative_feedback" disabled>{{$startup_feedback[0]->qualitative}}</textarea>
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <form class="rating pt-0 m-0" style="font-size:19px">
                                                                                            ...
                                                                                            <label>
                                                                                                <?php $i = 0;
                                                                                                    for($i = 0; $i < $startup_feedback[0]->punctuality; $i++) {
                                                                                                        echo '<span class="icon text-info">★</span>';
                                                                                                    }  for($i = $startup_feedback[0]->punctuality; $i < 5; $i++) {
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <form class="rating pt-0 m-0" style="font-size:19px">
                                                                                            <label>
                                                                                                <?php $i = 0;
                                                                                                    for($i = 0; $i < $startup_feedback[0]->problem_understanding; $i++) {
                                                                                                        echo '<span class="icon text-info">★</span>';
                                                                                                    }  for($i = $startup_feedback[0]->problem_understanding; $i < 5; $i++) {
                                                                                                        echo '<span class="icon">★</span>';
                                                                                                    } ?>
                                                                                            </label>
                                                                                        </form>                    
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <form class="rating pt-0 m-0" style="font-size:19px">
                                                                                            <label>
                                                                                                <?php $i = 0;
                                                                                                    for($i = 0; $i < $startup_feedback[0]->allotted_enough_time; $i++) {
                                                                                                        echo '<span class="icon text-info">★</span>';
                                                                                                    }  for($i = $startup_feedback[0]->allotted_enough_time; $i < 5; $i++) {
                                                                                                        echo '<span class="icon">★</span>';
                                                                                                    } ?>
                                                                                            </label>
                                                                                        </form>                    
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <form class="rating pt-0 m-0" style="font-size:19px">
                                                                                            <label>
                                                                                                <?php $i = 0;
                                                                                                    for($i = 0; $i < $startup_feedback[0]->overall_experience; $i++) {
                                                                                                        echo '<span class="icon text-info">★</span>';
                                                                                                    }  for($i = $startup_feedback[0]->overall_experience; $i < 5; $i++) {
                                                                                                        echo '<span class="icon">★</span>';
                                                                                                    } ?>
                                                                                            </label>
                                                                                        </form>                    
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        ...
                                                                                        <option id="val"> </option>
                                                                                            @foreach ($yn as $ynv)
                                                                                                <option  <?php if($ynv->id == $startup_feedback[0]->another_session) echo "selected" ?> value = '{{$ynv->id}}'> {{$ynv->val}} </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </div>
                                                                                </div>

                                                                                @if ($startup_feedback[0]->another_session == 1)
                                                                                        ...
                                                                                        <select class="form-control" name="mbusiness_domain_area" id="mbusiness_domain_area" style="height: unset;" disabled>
                                                                                            <option id="val"> </option>
                                                                                                @foreach ($business_domain_area as $bda)
                                                                                                    <option <?php if($bda->id == $startup_feedback[0]->areas_of_business_and_management_competence) echo "selected" ?> value = '{{$bda->id}}'> {{$bda->industry_experience}} </option>
                                                                                                @endforeach
                                                                                        </select>
...
$(document).ready(function(){
    ...
    @foreach($startup_mildstone as $mentor)
